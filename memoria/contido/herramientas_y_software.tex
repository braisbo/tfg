...
\subsection{OpenGL}
\acrfull{opengl} es una \acrshort{api} multiplataforma estándar para renderizado de gráficos 3D en tiempo real. En este proyecto se utiliza como motor  para renderizar los modelos anatómicos 3D sobre la imagen de la cámara, implementando shaders programables para iluminación y efectos visuales.
